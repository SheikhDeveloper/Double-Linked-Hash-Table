...
class Dict:
  def __init__(self, table_size = 10):
    self.table = [None, None, None, None] * table_size
    self.len = 0
      ...
      while current_value != None:
        if current_value[2] == key:
          ...
          if current_value != None:
            ...
            current_value = [self.top, None, None, None]
          self.top[1] = current_value
          self.table[index] = [None]
          current_index = hash(current_value[2]) % len(self.table)
          top_index = hash(self.top[2]) % len(self.table)
  ...
  def __contains__(self, key):
    ...
    if current_value != None:
      while current_value != None:
        if current_value[2] == key: return True
        current_value = current_value[1]
      return False
    else:
      return False
